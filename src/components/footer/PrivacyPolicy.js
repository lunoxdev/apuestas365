      ...
      <div className="flex items-center bg-gray-800 bg-opacity-70 justify-center min-h-screen">
        <div className="bg-black mt-28 mb-10 md:mb-0 md:mt-0 lg:mt-28 lg:mb-10 rounded-2xl shadow-black shadow-2xl w-5/6">
          <div className="px-8 py-5 text-start">
            <h1 className="text-xl text-center font-bold text-white mb-5">
              Política de privacidad y Cookies
            </h1>
            <p>Última actualización: 10/04/2023</p>
            <br></br>
            {/* section 0 */}
            <div className="text-xs text-justify-last text-gray-400 mb-5">
              <p>
            ...
            {/* section 1 */}
            <div className="text-xs text-justify-last text-gray-400 mb-5">
              <h1 className="text-white text-base mb-3">
                Tipos de Datos Recopilados
              </h1>
              <h2 className="text-white text-sm mb-2">Datos Personales</h2>
              <p>
              ...
              <h2 className="text-white text-sm mb-2 mt-2">Datos de Uso</h2>
              <p>
            ...
            <div className="text-xs text-justify-last text-gray-400 mb-5">
              ...
              <p></p>
              <h2 className="text-white text-sm mb-2 mt-2">
            ...
            <div className="text-xs text-justify-last text-gray-400 mb-5">
              ...
              <h1 className="text-white text-base mb-3 mt-2">
            ...
            <div className="text-xs text-justify-last text-gray-400 mb-5">
              ...
              <h2 className="text-white text-sm mb-2 mt-2">Contáctanos</h2>
              <p>
